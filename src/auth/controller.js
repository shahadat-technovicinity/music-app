...
const registerController = async (req, res) => {
  try {
    ...
    // Register user
    const user = await registerService({ name, email, password, role, fileUrl });
    res.status(201).json({
      success: true,
...
export { registerController, loginController, changePasswordController, forgetPasswordController,verifyOtpController, resetPasswordController, refreshTokenController,logoutController };